...
<html>
	...
	<body bgcolor="lightblue">
			...
			<div class="topBar">
			           è¯·</b><a href="index.jsp" target="_blank" class="login">主页</a>
			...
			<div class="shu">
				<div class="picture1">
					<input type="image" src="./img/8b13632762d0f70375cae9ff08fa513d2697c59d.jpg" width="300"height="400"/>
				</div> 
				<div class="word1">
					<p>
						<ul>
						...
						<form action="tatal" method="post">
							...
							<input type="text" value="泰戈尔诗集" name="1" style="display:none">
							<input type="text" value="140" name="2" style="display:none">
