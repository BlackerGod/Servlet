...
<html>
	...
	<body bgcolor="lightblue">
			...
			<div class="shu">
				<div class="picture1">
					<input type="image" src="./img/a.jpg" width="300"height="400"/>
				</div> 
				<div class="word1">
					<p>
						<ul>
						...
						<form action="tatal" method="post">
							...
							<input type="text" value="时间简史" name="1" style="display:none">
							<input type="text" value="80" name="2" style="display:none">
