...
<html>
	...
	<body bgcolor="lightblue">
			...
			<div class="shu">
				<div class="picture1">
					<input type="image" src="./img/s3035238.jpg" width="300"height="400"/>
				</div> 
				<div class="word1">
					<p>
						<ul>
							<li>书名：《七个谎言》</li>
							<li>作者：马丁·路德Martin Luther</li>
							<li>上市时间：2008年</li>
							<li>售价：100.00元</li>
						</ul>
						<form action="tatal" method="post">
							<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</ng-pluralize>请输入数量:<input type="text" name="amount"></p>
							<input type="text" value="七个谎言" name="1" style="display:none">
							<input type="text" value="100" name="2" style="display:none">
