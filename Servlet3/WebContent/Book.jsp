...
<form method="post" action="Book.jsp">
	<%      
            ...
            if(request.getParameter("b1")!=null)
                session.setAttribute("s1",request.getParameter("b1"));
            
            if(request.getParameter("b2")!=null)
                session.setAttribute("s2",request.getParameter("b2"));
            
            if(request.getParameter("b3")!=null)
                session.setAttribute("s3",request.getParameter("b3"));
            
            if(request.getParameter("b4")!=null)
                session.setAttribute("s4",request.getParameter("b4"));
   %>	
	<div class="logo">
	...
	<div class="zong1">
		...
		<div class="wen1">
         ...
         <p>
             <input type="checkbox" name="b1" value="时间简史">时间简史&nbsp; 
	...
	<div class="zong2">
		...
		<div class="wen2">
         ...
         <p>
             <input type="checkbox" name="b2" value="七个谎言">七个谎言&nbsp;
	...
	<div class="zong3">
		...
		<div class="wen1">
         ...
         <p>
             <input type="checkbox" name="b3" value="史记">史记&nbsp;
	...
	<div class="zong4">
		...
		<div class="wen2">
         ...
         <p>
             <input type="checkbox" name="b4" value="泰戈尔诗集">泰戈尔诗集&nbsp;
